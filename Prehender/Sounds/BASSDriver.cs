...
namespace Prehender.Sounds
{
    public class BASSSound : iSoundSourceObject, iActiveSoundObject, IDisposable
    {
        ...
        public BASSSound(int streamnum, IntPtr freeblock)
            : this(streamnum)
        {
        ...
        private static T ClampValue<T>(T Value, T min, T max) where T : IComparable
        {
            //cast to IComparable
        ...
        public float Tempo
        {
            ...
            set
            {
                ...
                int CalculatedValue;
                CalculatedValue = ClampValue((int)(value * 128), 0, 255);
    ...
    class BASSDriver : iSoundEngineDriver
    {
        ...
        public BASSDriver(String pluginFolder)
        {
            ...
            String x86DLL = Path.Combine(PrehenderGame.instance.GetAppDataFolder(), "Lib\\x86");
            String x64DLL = Path.Combine(PrehenderGame.instance.GetAppDataFolder(), "Lib\\x64");
        ...
        public BASSDriver()
            : this(Path.Combine(PrehenderGame.instance.GetAppDataFolder(), "SoundPlugin"))
        {
